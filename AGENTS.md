...
- Reuse approved ChatEnv profiles for credentials and service configuration. Do not create secret-bearing files in the source repository or task workspace, and never print secret values.
